...
export default function  TabLayout(){
    return(
        <Tabs screenOptions={{headerShown:false,tabBarInactiveTintColor:"white",tabBarActiveTintColor:"#FF6A1A"}}>
            ...
            {/* the radio station will be apply  like that functionality on the future o next version */}
            ...
            <Tabs.Screen name='setting' options={{title:"Configuracion",tabBarIcon:({color})=><MaterialIcons name="settings" size={28} color={color} />}}/>
        </Tabs>
    )
}